...
class GitHubInstallationRepositorySelectionType extends Type
{
    ...
    public function convertToPhpValue($value, AbstractPlatform $platform)
    {
        ...
        return RepositorySelectionFactory::create($value);
    }
    ...
    {
        return 'GitHubInstallationRepositorySelection';
    }
}
